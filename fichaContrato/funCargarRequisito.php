<?php
    ...
    if ( empty($_FILES['documento']['tmp_name']) != 1) {
        ...
        if($extension != ""){
            ...
            $filename = $_POST['ficha']."_".$_POST['requisito']."_requisto".$extension; 
            $bytes = file_put_contents('../../adm-nortrans/vistas/img/requisitos/'.$filename, $archivo);
            $item = array(
                'ficha' => $_POST['ficha'],
